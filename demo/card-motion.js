...
export class CardMotion {
 ...
 apply(renderer){
  ...
  this.slot.style.setProperty('--card-rotation','0deg');
  if(renderer.setCardPose){renderer.setCardPose(this.offset/274,0);}
   ...
   ctx.save();ctx.translate(122,137-this.offset);
