...
uniform sampler2D normalMap,background;uniform vec2 normalSize;uniform float angle,lightAngle,period,spread,strength,kind,inspect,flatFloor,localBoost,threshold,softness,whiteGain,richness,patternScale,bend;
