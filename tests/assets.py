...
for name in ['book-cobalt', 'book-cover', 'book-pages', 'book-shadow', *[f'book-ring-{i}' for i in range(4)], 'base-0', 'base-1', 'base-2', 'base-3']:
...
print('PASS: 9 reference hashes, 8 atlas tiles/orientations, 8 lossless packed normals, 12 lossless WebP images, 3 red-dot patches.')
