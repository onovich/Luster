...
uniform sampler2D normalMap,background;uniform float angle,lightAngle,period,spread,strength,kind,inspect,flatFloor,localBoost,threshold,softness,whiteGain;
